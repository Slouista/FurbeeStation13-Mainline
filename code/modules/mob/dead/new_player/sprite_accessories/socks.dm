...
/datum/sprite_accessory/socks/thigh_high_stripes_pink
	name = "Thigh-high - Striped - (Pink)"
	icon_state = "codersocks_pink"

/datum/sprite_accessory/socks/thigh_high_stripes_blue
	name = "Thigh-high - Striped - (Blue)"
	icon_state = "codersocks_blue"

/datum/sprite_accessory/socks/thigh_high_stripes_trans
	name = "Thigh-high - Striped - (Trans)"
