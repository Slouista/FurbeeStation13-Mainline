/client/proc/panicbunker()
	...
	send2tgs("Panic Bunker", "[key_name(usr)] has toggled the Panic Bunker, it is now [new_pb ? "enabled" : "disabled"].")
...
/client/proc/addbunkerbypass(ckeytobypass as text)
	...
	send2tgs("Panic Bunker", "[key_name(usr)] has added [ckeytobypass] to the whitelist.")
...
/client/proc/revokebunkerbypass(ckeytobypass as text)
	...
	send2tgs("Panic Bunker", "[key_name(usr)] has removed [ckeytobypass] from the current round's bunker bypass list.")
